...
var useColumnSelector = function useColumnSelector(availableColumns, columnVisibility, showColumnSelector) {
  ...
  if (numberOfHiddenFields === 1) {
    buttonText = _react.default.createElement(_i18n.EuiI18n, {
  ...
  var columnSelector = _react.default.createElement(_popover.EuiPopover, {
  ...
  }, _react.default.createElement("div", null, allowColumnHiding && _react.default.createElement(_popover.EuiPopoverTitle, null, _react.default.createElement(_i18n.EuiI18n, {
    ...
    return _react.default.createElement(_drag_and_drop.EuiDraggable, {
      ...
      return _react.default.createElement("div", {
        ...
        gutterSize: "m",
        alignItems: "center"
      }, _react.default.createElement(_flex.EuiFlexItem, null, allowColumnHiding ? _react.default.createElement(_form.EuiSwitch, {
        name: id,
        label: id,
      ...
      }, id)), isDragEnabled && _react.default.createElement(_flex.EuiFlexItem, {
        grow: false
  ...
  })))))), allowColumnHiding && _react.default.createElement(_popover.EuiPopoverFooter, null, _react.default.createElement(_flex.EuiFlexGroup, {
    gutterSize: "s",
