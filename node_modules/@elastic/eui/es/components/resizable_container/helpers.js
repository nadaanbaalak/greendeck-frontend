...
export var useContainerCallbacks = function useContainerCallbacks(_ref) {
  ...
  var onKeyDown = useCallback(function (ev) {
    ...
    var shouldResizeHorizontalPanel = isHorizontal && (keyCode === keyCodes.LEFT || keyCode === keyCodes.RIGHT);
    var shouldResizeVerticalPanel = !isHorizontal && (keyCode === keyCodes.UP || keyCode === keyCodes.DOWN);
    ...
    if ((shouldResizeHorizontalPanel || shouldResizeVerticalPanel) && prevPanelId && nextPanelId) {
      ...
      var prevPanelSize = pxToPercent(prevPanel.getSizePx() - (keyCode === keyCodes.UP || keyCode === keyCodes.LEFT ? 10 : -10), containerSize - resizersSize);
      var nextPanelSize = pxToPercent(nextPanel.getSizePx() - (keyCode === keyCodes.DOWN || keyCode === keyCodes.RIGHT ? 10 : -10), containerSize - resizersSize);
