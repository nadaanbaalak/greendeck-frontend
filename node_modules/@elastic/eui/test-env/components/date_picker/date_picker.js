...
EuiDatePicker.__docgenInfo = {
  ...
  "props": {
    ...
    "popoverPlacement": {
      ...
      "required": false,
      "description": "Sets the placement of the popover. It accepts: `\"bottom\"`, `\"bottom-end\"`, `\"bottom-start\"`, `\"left\"`, `\"left-end\"`, `\"right\"`, `\"right-end\"`, `\"right-start\"`, `\"top\"`, `\"top-end\"`, `\"top-start\"`"
    },
    "className": {
      "type": {
        "name": "string"
